...
const Navbar = () => {
  ...
  return (
    <>
      <div className="fixed hidden md:flex z-50 items-center justify-between gap-5 text-[#D9D9D9] top-0 w-full bg-[#161825] px-2 md:px-4 lg:px-10 py-5">
        <div className="flex gap-10 text-lg lg:text-xl">
          <a
